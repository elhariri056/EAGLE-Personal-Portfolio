...
if ($name == "") {
    ...
    $to = 'speedxxxx7@gmail.com';
    $subject = 'EL hariri Contact Query';
    ...
    $headers .= 'From:  EL HARIRI <speedxxxx7@gmail.com>' . "\r\n";
    $headers .= 'cc: speedxxxx7@gmail.com' . "\r\n";
    $headers .= 'bcc: speedxxxx7@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f speedxxxx7@gmail.com');
